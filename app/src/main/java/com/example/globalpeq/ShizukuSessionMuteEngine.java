...
final class ShizukuSessionMuteEngine {
    ...
    private SessionInfo preferNewerPackagedSession(SessionInfo current, SessionInfo candidate) {
        if (candidate == null || candidate.packageName.isEmpty()) {
            return current;
        }
        if (current == null || current.packageName.isEmpty()) {
            return candidate;
        }
    ...
    private MuteScanResult muteOtherSessions(List<SessionInfo> sessions,
        ...
        LinkedHashSet<String> desiredPackages = new LinkedHashSet<>();
        ...
        return new MuteScanResult(
                ...
                desiredMuteSessionIdsForVerification,
